...
<head>
    ...
    <link rel="stylesheet" href="css/blood_camp.css">
...
<body>
	...
	<div class="container">
		...
		<form action="blood_camps.jsp" method="post" class="search">
			...
			<div class="col-sm-5">
				...
				try {
					...
					ResultSet rs = stm.executeQuery("select distinct campid,o_name,o_contactno,o_email,camp_name,camp_address,state,city,camp_date,camp_start_time,camp_end_time from vbdcamps ");
