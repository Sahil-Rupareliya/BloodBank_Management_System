...
<body>
	...
	%>
	<form method="post" action="updatebank.jsp">
			...
			<div class="location-box">
				...
				<br>
			       ...
			       <label for="id">Id*</label> <input type="text" id="id"
					name="id" value="<%=resultSet.getString("id")%>" required>

				<br>
				
				
				<br> <label for="name">Blood Bank Name:*</label> <input
					type="text" id="name" name="name"
					value="<%=resultSet.getString("name")%>" required> 
					<br>
				<br>  
				<label for="mobile no">Contact no:*</label> <input
					type="text" id="contact-no" name="contactno"
					value="<%=resultSet.getString("contactno")%>" required>
					 <br>
				 <br> 
				  <label for="name">Address:*</label> <input type="text"
					...
					<br>
					<label
					for="name">Pincode:*</label> <input type="text" id="pcode"
					name="pcode" value="<%=resultSet.getString("pcode")%>" required>
				<br>
				
				<br> <input type="submit" value="Confirm Updade?"> <input
					type="submit" type="reset" value="Cancel">
			</div>
