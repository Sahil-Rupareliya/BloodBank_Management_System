...
<form action="patient_email_check" method="post" onsubmit="return validateForm()">
        <div class="left-form">
            <h1 style="text-align: center;">Thalasemia/Blood Disorder Patient Sign-Up</h1>
            <br>
            <br>
            <hr>
            <hr>
    ...
    <br><br>
        ...
        <select id="state" name="state" required>
         ...
         <label for="district">City:*</label>
          ...
          <input type="text" id="nearest_blood_bank" name="nearest_blood_bank" required>
    ...
    <section id="otp-section" style="display: none;">
        ...
        <input type="submit" value="CLICK HEAR.....">
         ...
         <br>
         <br>
          <lable>Already A Member??<a href="patient_login.jsp" style="text-decoration:underline">Login Now</a></lable>
