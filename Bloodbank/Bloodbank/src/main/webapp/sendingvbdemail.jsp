...
<html>
    <head>
        ...
        <title>SENDING MAIL TO VBD CAMPS</title>
        <style>
body {
...
<br>
<br>
<a href="mvbdcamps.jsp" class="button" ><button class="button" style="width:100px;height:40px;background-color:#6e0202;color:white;font-size:18px;cursor:pointer">OK</button>
</a>
</div>
    </body>
</html>