...
<section class="newsection" style="font-family: Georgia, serif;">Red Cross Blood Service
  ...
  <h1>BLOOD REQUEST</h1>
  <p>Name: <%=resultSet.getString("o_name") %></p>
  <p>o_contactno <%=resultSet.getString("o_contactno") %></p>
  
  <p>o_email <%=resultSet.getString("o_email") %></p>
  <p>camp_name <%=resultSet.getString("camp_name") %></p>
  
  <form method="post" action="resultsvbd">
    <input type="hidden" name="campid" value="<%=resultSet.getString("campid") %>">
