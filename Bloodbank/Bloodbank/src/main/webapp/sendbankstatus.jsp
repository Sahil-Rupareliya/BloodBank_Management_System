...
<html>
    <head>
        ...
        <title>SEND STATUS FOR BANK</title>
...
if(resultSet.next()){
%>
<form method="post" action="sendingbankemail.jsp">
<h1>Reply To Blood Bank</h1>
<hr>
<hr>
<br>
From Email Id:
...
<br><br>
Subject:
<input type="text" name="subjects" value="status for add Blood Bank">
<br><br>
