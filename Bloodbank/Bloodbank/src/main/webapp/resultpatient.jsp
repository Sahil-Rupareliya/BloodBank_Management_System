<%-- 
    Document   : resultpatients
    Created on : Apr 14, 2023, 8:18:45 AM
    Author     : JENISH
--%>
...
<section class="newsection" style="font-family: Georgia, serif;">Red Cross Blood Service
  ...
  <h1>Blood Request</h1>
  <p>Name: <%=resultSet.getString("first_name") %></p>
  <p>Require date <%=resultSet.getString("Requiredate") %></p>
  
  <p>Quantity: <%=resultSet.getString("Quantity") %></p>
  <p>Blood_group <%=resultSet.getString("Blood_group") %></p>
  
  <form method="post" action="resultpatients">
