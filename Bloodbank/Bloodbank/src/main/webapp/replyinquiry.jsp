<%-- 
    Document   : replyinquiry
    Created on : Apr 4, 2023, 4:56:56 PM
    Author     : JENISH
--%>
...
%>
<form method="post" action="sendinquiryreply.jsp">
<h1>Reply To Inquiry</h1>
<hr>
<hr>
<br>
From Email Id:
<input type="email" name="mail" value="chintangabani25@gmail.com">
<br><br>
To Email Id:
<input type="email" name="mailid" value="<%=resultSet.getString("email") %>">
<br><br>
Subject:
<input type="text" name="subject" value="Reply From Admin For Your Question">
<br><br>
Question:
<input type="text" name="question" value="<%=resultSet.getString("msg") %>">
<br><br>
Answer:
<textarea rows="12" cols="40" name="mess"></textarea>
<br><br>
