...
PreparedStatement countStmt = conn.prepareStatement("SELECT COUNT(*) FROM donateblood");
...
PreparedStatement stmt = conn.prepareStatement("SELECT * FROM donateblood LIMIT ?, ?");
stmt.setInt(1, start);
         ...
         <h2> list of inquiry</h2>
			...
			<table class="intable" border="3px solid black" padding="10px">
				...
				<tr class="inner">
					...
					<td><%=resultSet.getString("tdn")%></td>
					<td><a href="editdonate.jsp?id=<%=resultSet.getString("id")%>"><button
								class="btn-edit"><i class="fas fa-pencil-alt"></i>Edit</button></a></td>
					<td><a
						href="deletedonate.jsp?id=<%=resultSet.getString("id")%>"><button
								class="btn-delete"><i class="fas fa-trash-alt"></i>Delete</button></a></td>
				</tr>
<%} %>
		 ...
		 <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js">  </script>
		   ...
		   <script type="text/javascript">
			   ...
			   swal("Congrats"," Form data updated Successfully","success");
		           ...
		           if(status=="success1")
				   {
				   swal("Congrats"," Data Delete Successfully","success");
				   }
		   </script>
		   <script>
