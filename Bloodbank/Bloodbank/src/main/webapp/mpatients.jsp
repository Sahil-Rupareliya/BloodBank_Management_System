<%-- 
    Document   : mpatients
    Created on : Apr 13, 2023, 8:15:12 PM
    Author     : JENISH
--%>
	...
	<div class="name">
       ...
       <div class="mid-left">
		...
		<ul class="mid-left-sec-9 nav" style="position:sticky; top:518px;">
			...
			<li><a class="nav__link active" href="mpatients.jsp">Manage patient request </li>
		</ul>
		<a href=""></a>
...
PreparedStatement countStmt = conn.prepareStatement("SELECT COUNT(*) FROM patients");
...
PreparedStatement stmt = conn.prepareStatement("SELECT * FROM patients LIMIT ?, ?");
stmt.setInt(1, start);
              ...
              <% while (resultSet.next()) { %>
                         <tr>
                                ...
                                <td><%=resultSet.getString("Quantity")%></td>
                                 <td><a href="showpatientsfile.jsp?id=<%=resultSet.getString("id") %>">show document</a></td>
                               <td><%=resultSet.getString("status")%></td>
                                <td><a href="sendpatient.jsp?id=<%=resultSet.getString("id") %>"><button type="button"  class="btn-delete"> <i class="fas fa-info-circle"></i>SEND</button></a></td>
                                <td><a href="resultpatient.jsp?id=<%=resultSet.getString("id") %>"><button type="button"  class="btn-delete" style="background-color:green;">  <i class="fas fa-envelope-open-text"></i>RESULT</button></a></td>
                         </tr>
             <% } %>
</table>
