...
<head>
    ...
    <title>THALASEMIA/BLOOD DISORDER REQUEST</title>
...
<body>
    ...
    <hr class="h1">
      ...
      <section class="login">
        ...
        <div class="log1">
          <img src="./photos/thala.jpg" alt="">
        </div>
           <div class="center">
            
               <h1 class="h1">Thalasemia/Blood Disorder
                <br> Patient Sign-in</h1>
              
               <form method="post" action="patient_logi">
                 <div class="txt_field">
 ...
 <input type="password" name="password" autocomplete="current-password" required id="id_password">
                <i class="far fa-eye" id="togglePassword" style="margin-left: -30px; cursor: pointer;"></i>                  <span></span>
                  <label> Password</label>
                 </div>
        
                 <p class="forgot-password">Forgot password? <a href="./patient_forgetpassword.jsp">Reset</a></p>
                 <input type="submit" value="SIGN-IN" style="margin-top:20px">
        
                 <div class="signup_link">Not a Register?<a href="./patient_regis.jsp">Signup</a></div>
                 <div class="log2">
